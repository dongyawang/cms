...
<div class="main_images" style="margin-bottom:10px;"><div class="main_images1"><div class="main_images2">
...
<?php
  ...
  while($row = mysql_fetch_array($SQL))
  {
   ...
   echo "<div class=\"goods_content_x_pic\"> <a href=\"product_details.php?cz=${id}\" target=\"_blank\"><img src=\"upfiles/product/$image_name\" border=\"0\" height=\"140\" width=\"140\" /></a></div>";
   echo "<div class=\"goods_content_x_name\"><a href=\"product_details.php?cz=${id}\" target=\"_blank\">${title}</a></div>";
   echo "</div>";
  }
?>   
       </div>
...
<div class="main_news"><div class="main_news1"><div class="main_news2">
  ...
  while($row = mysql_fetch_array($SQL))
  {
   ...
   $title = $row["title"]; 
   $title =cut($title,"16",'...');
   echo "<div class=\"main_right_content_x1\"><img src=\"Images/small.gif\" border=\"0\" width=\"3\" height=\"5\" /> <a href=\"news_details.php?cz=${id}\">${title}</a>${time_create}</div>";
  }
?>
       </div>
</div></div></div>
