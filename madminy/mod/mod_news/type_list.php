...
<table>
            <tr><td colspan="5" style="background-color:#F1EFEF;text-align:left;">新闻文章 >> 分类列表</tr>
...
$total=mysql_num_rows(mysql_query("select * from cms_news_type order by id desc"));  //执行查询获取总记录数
...
$exec="select * from cms_news_type order by id desc limit $offset,$pagesize"; //执行查询
