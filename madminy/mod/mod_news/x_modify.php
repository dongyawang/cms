...
//登录数据列表
$del_a=safe($_GET["a"]);
$sql=mysql_query("select * from cms_news_list where id=$del_a");
...
<form name="myform" method="post" action="x_modify_deal.php?cz=<?php echo $id;?>">
       <div class="main_x" style="background-color:#F1EFEF;">新闻管理 >> 修改新闻</div>
       <div class="main_x">新闻标题：<input type="text" name="title"style="width:500px;height:18px;color:#3E3A3A;" value="<?php echo $title;?>"></div>
