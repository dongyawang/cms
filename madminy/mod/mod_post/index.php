...
//获取网站简介内容
$sql=mysql_query("select * from cms_post limit 0 ,1");
...
<form name="myform" method="post" action="modify_deal.php?cz=<?php echo $id;?>">
        <div class="main_x" style="background-color:#F1EFEF;">站内公告>> 公告详情</div>
        <div class="main_x">公告修改：</div>
        <div class="main_x"><textarea id="your_editor_id" name="post_content" cols="100" rows="8" style="width:98%;height:300px;"><?php echo $post_content;?></textarea></div>
