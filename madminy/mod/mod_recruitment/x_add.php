...
<form name="myform" method="post" action="x_add_deal.php">
       <div class="main_x" style="background-color:#F1EFEF;">招聘管理 >> 添加招聘</div>
       <div class="main_x">招聘标题：<input type="text" name="title"style="width:500px;height:18px;color:#3E3A3A;"></div>
