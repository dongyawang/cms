...
<form name="myform" method="post" action="type_add_deal.php">
            <tr>
                  <td colspan="2" style="background-color:#F1EFEF;">产品管理 >> 添加分类</td>
            </tr>
            <tr>
                  <td>分类名称：</td>
                  <td><input type="text" name="name"style="width:250px;height:18px;color:#3E3A3A;"></td>
            </tr>
            <tr>
                  <td>分类序列：</td>
                  <td><input type="text" name="rank"style="width:250px;height:18px;color:#3E3A3A;"></td>
            </tr>
            <tr>
