...
include('../../../function/safe.php');
      ...
      $sqllink = "insert into cms_product_type (name,rank,time_create)
                    values('$name','$rank','$time_create')";
      ...
      if($sqldata == TRUE)
        ...
        {
        echo "<script> alert('添加失败！'); window.location.href='type_list.php';</script>";
        }
?>