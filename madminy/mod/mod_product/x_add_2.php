...
<div class="main">
       ...
       <div class="main_x">产品图片(效果图)：<img src="../../../upfiles/product/<?php echo $image_name;?>" border="0" height="140" width="140"/></div>
       <form name="myform" method="post" action="x_add_2_deal.php?cz=<?php echo $id;?>">
       <div class="main_x">产品标题： <input type="text" name="title"style="width:350px;height:18px;color:#3E3A3A;"></div>
