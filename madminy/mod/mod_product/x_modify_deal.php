...
include('../../../function/safe.php');
        ...
        if($query==true){ echo "<script>alert('产品信息修改成功!');window.location.href='x_list.php';</script>";
        }else{echo "<script>alert('产品信息修改失败!');window.location.href='x_modify.php';</script>";}
?>