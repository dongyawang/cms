...
<div class="navigation_center">
	     ...
	     <div class="navigation_text"><a href="<?php echo $iurl; ?>/introduction.php" title="introduction" target="_blank">About us</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
	     <div class="navigation_text"><a href="<?php echo $iurl; ?>/news_1.html" title="news" target="_blank">News</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
         <div class="navigation_text"><a href="<?php echo $iurl; ?>/product_1.html" title="product" target="_blank">Product</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
		 <div class="navigation_text"><a href="<?php echo $iurl; ?>/message.php" title="message" target="_blank">Message</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
         <div class="navigation_text"><a href="<?php echo $iurl; ?>/contactus.php" title="contact" target="_blank">Contact</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
         <div class="navigation_text"><a href="<?php echo $iurl; ?>/recruitment_1.html" title="recruit" target="_blank">Recruit</a></div>
         <div class="navigation_image"><img src="<?php echo $iurl;?>/images/daohang_image.gif" alt="<?php echo $name_website;?>" title="<?php echo $name_website;?>"/></div>
